...
- [lucas42 direction vs question](feedback_lucas42_direction_vs_question.md) — when lucas42 rejects an approach and describes a concrete alternative, treat it as approved direction, not an open question
