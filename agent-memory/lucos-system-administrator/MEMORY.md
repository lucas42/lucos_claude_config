...
- **lucos_claude_config#129** (clean-status target): PR #130 (gitignore tmp-files + persistent-dirt detection) open for review. Item 2 (`settings.json` restart check) pending — needs a fresh session start to verify. `settings-json-restart-verification-129.md`.
