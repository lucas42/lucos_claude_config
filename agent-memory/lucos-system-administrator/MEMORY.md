...
- **lucos_claude_config#127** (HEAD drift fix): Ready/High/mine, awaiting `/next` dispatch. Settled scope = extend `return-to-main.sh` + branch-guard + mixed reset, NOT a new tool. `project_head_drift_fix_127.md`.
