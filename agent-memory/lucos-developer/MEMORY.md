...
- [Standalone "PR approved" ping needs its own fresh re-fetch](feedback_standalone_ping_staleness.md) — a substantive report's fetch doesn't cover a later bare status ping; 4 stale pings caught 2026-08-23
