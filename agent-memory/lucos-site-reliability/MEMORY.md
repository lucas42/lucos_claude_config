...
- [Bare "aborted due to timeout" debug? The probe already measured it and threw it away](pattern_probe_measures_then_discards_latency.md) — read source first; measure exact call in-container; arachne#735 + seinn#583.
