...
- **8s stagger is not enough** for 15-pipeline estate triggers. On 2026-04-19 I triggered 15 fresh pipelines at 8s intervals; mirror still saturated (`unexpected commit digest` on rust:1.95-alpine 270MB layer for lucos_configy, TLS handshake timeout for lucos_media_weightings). With ~60-120s build-amd64 steps, 8s gap = ~5-8 builds hitting mirror simultaneously. Restart cleared it immediately. Safer stagger for estate triggers: 20-30s, or batch in groups of 5 with 2-min gaps.
