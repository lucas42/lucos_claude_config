...
- **Rebuild procedure:** **lucas42/lucos#296** (sysadmin's runbook; Awaiting Decision / Critical / owner lucas42; item 2 covers RAID). Linked in #294 and #297. Sysadmin will ask SRE for the data-restore specifics.
