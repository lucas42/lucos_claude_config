...
**The specific failure:** my persona's "Calibrating Follow-up Issue Proposals" rule fired correctly on the *solution* — I talked myself out of a CI assertion on impact-vs-maintenance grounds. It never fired on the *question*, because that section is scoped to proposals I originate. A question arriving from a teammate, phrased as a correction to me, bypassed the test entirely. **Being told "your scope is too narrow" is not evidence that it is.**
