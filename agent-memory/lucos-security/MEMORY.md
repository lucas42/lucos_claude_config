...
- [lucos_aithne_jsclient ADR-0001 review](lucos-aithne-jsclient-adr-review.md) — REQUEST_CHANGES on PR #1 (2026-07-10): kid log-injection gap, loginUrl open-redirect enforcement, verifyToken() scope-gate split. Verify these landed on re-review.
