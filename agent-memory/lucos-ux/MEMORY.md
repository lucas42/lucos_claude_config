...
- [Long-doc findings need a reachable argument, not just an early mention](feedback_long_doc_findings_need_reachable_argument.md) — callout early, don't reorder dependent sections (lucos#289 incident report)
