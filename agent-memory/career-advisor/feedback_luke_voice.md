...
- **Measured, dry, slightly understated.** Luke's settled voice is calm and direct. Not enthusiastic-corporate, not breathless. The Wikimedia and BBC letters in his existing library have this tone naturally; reach for that register.
- **Honest gap notes are welcome.** When Luke doesn't have something the JD asks for, say so plainly with adjacent evidence — see the Smart-Pension / regulated-pensions pattern. Don't dress up gaps.
