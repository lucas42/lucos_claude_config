...
- [CV font-mandate render](feedback_cv_font_mandate_render.md) — meet a mandated font (e.g. Arial 12pt) via post-render theme1.xml swap; template default is Calibri/Cambria
