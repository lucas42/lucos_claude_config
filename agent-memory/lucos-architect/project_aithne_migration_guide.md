...
- **lucas42/lucos_aithne#148** — ⏳ dev/prod issuer model; consumers hardcode `https://aithne.l42.eu`. Recommend env-injected `AITHNE_ORIGIN`. Affects whether client-side silent-refresh (#147 option A) is even possible (SameSite/Secure/Domain cookie scoping).
