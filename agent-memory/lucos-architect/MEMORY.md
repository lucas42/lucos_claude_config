...
- [aithne migration guide](project_aithne_migration_guide.md) — consumer-migration guide = aithne#159 (UNWRITTEN/held); gated on arachne#657 (✅ Option 1 per-service 403) + aithne#147 (session continuity, POST-data-loss) + aithne#148 (issuer model)
