...
- [aithne migration guide](project_aithne_migration_guide.md) — SPLIT: ADR-0003 draft PR aithne#182 (ADR-only, re-requested) + guide draft PR aithne#186 (revised: bulk/no-machine-keys/explicit-navbar-version, parked on navbar#174 version); deferred impl aithne#181 + navbar#174
