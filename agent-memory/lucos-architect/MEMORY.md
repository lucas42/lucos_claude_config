...
- [GitHub cc / @-mentions don't notify agents](feedback_no_github_cc_as_delivery.md) — `cc'ing @lucos-foo` in an issue body is signage for humans, not delivery; pair with SendMessage (2026-05-28)
