...
- [aithne migration guide](project_aithne_migration_guide.md) — consumer-migration guide = aithne#159 (UNWRITTEN/held); gated on arachne#657 (✅ Option 1 per-service 403) + aithne#148 (✅ AITHNE_ORIGIN env + dev→dev) + aithne#147 (⏳ session continuity / POST-data-loss, awaiting lucas42 pick — last gate)
