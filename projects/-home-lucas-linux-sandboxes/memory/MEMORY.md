...
- [avalon disk failure](project_avalon_disk_failure.md) — P1 lucos#294 (2026-09-14): single disk died; data rescued to xwing+salvare `~lucos-agent/emergency-backups-2026-09-14/` (README = restore guide); disk swapped + Trixie installed 2026-09-15; rebuild via lucos#296 (Step 1 lucas42 → sysadmin Steps 2–4 → SRE Step 5). DNS zone expires 2026-10-12 07:09Z. SRE watch stopped — ping SRE when avalon is back; routine triage still owed
