...
- [avalon disk failure](project_avalon_disk_failure.md) — P1 lucos#294 (2026-09-14): single disk died; data rescued to xwing+salvare `~lucos-agent/emergency-backups-2026-09-14/` (README = restore guide); rebuilt on Trixie overnight 2026-09-15/16, estate restored; open: mail#79, dns#135, verification + report. DNS zone expires 2026-10-12 07:09Z. SRE watch stopped — ping SRE when avalon is back; routine triage still owed
