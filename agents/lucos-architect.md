...
This returns all open issues across lucos repositories that carry the `owner:lucos-architect` label. Work through each one in turn. If the script returns nothing, report that there are no currently assigned issues.
