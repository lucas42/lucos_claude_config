...
| Value | When to set |
|---|---|
| Ideation | The goal or scope is still vague or exploratory, or an agent owes design work — including following lucas42's direction on a previously-Awaiting-Decision ticket where investigation, value-picking, or sub-option choice is still required. Park at low priority until someone revisits with a clearer picture. |
